...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Text = L"Window Height";
			// 
			// label3
			// 
			...
			this->label3->Text = L"Distance Between Main Limbs";
			...
			this->label4->Size = System::Drawing::Size(206, 13);
			this->label4->TabIndex = 3;
			this->label4->Text = L"Distance Between Main and Return Limbs";
			// 
			// label5
			// 
			...
			this->label7->Text = L"Cross Section of Main Limbs";
			// 
			// label8
			// 
			...
			this->label8->Text = L"Cross Section of Main Yokes";
			// 
			// label9
			// 
			...
			this->label9->Size = System::Drawing::Size(146, 13);
			this->label9->TabIndex = 8;
			this->label9->Text = L"Cross Section of Return Parts";
			// 
			// label10
			// 
			...
			this->label11->Size = System::Drawing::Size(131, 13);
			this->label11->TabIndex = 10;
			this->label11->Text = L"Flux Density in Main Limbs";
			// 
			// textBox1
			// 
